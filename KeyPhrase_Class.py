...
class Keyphrase():
    ...
    def Basic_GraphModel(self,window_size,file_name):
        ...
        with open(args.data) as f_:
            for line in f_:
                ...
                for idx in xrange(len(fileList)):
                    ...
                    AKE = Keyphrase(fileList[idx], args.window)
                    AKE.Basic_GraphModel(args.window,file_name)
                    AKE.CValueModel()
                    KeyPhrase = AKE.FinalKeyPhrase
