...
MeasurePerformance("author.stem");
MeasurePerformance("reader.stem");
MeasurePerformance("combined.stem");
...
# print performance of test.author/reader/combined
  ...
  #print "-------------------------------------------------------------------------------------\n";
  print "".uc($current_set)."\tMatch\tPrecision\tRecall\tFscore\n";
  ...
  print "Top05\t".$matchNo5."\t".$Prec5b."\t".$Recall5b."\t".$Fscore5b."\n";
  print "Top10\t".$matchNo10."\t".$Prec10b."\t".$Recall10b."\t".$Fscore10b."\n";
  print "Top15\t".$matchNo15."\t".$Prec15b."\t".$Recall15b."\t".$Fscore15b."\n";
}
